...
namespace Northwind.Web.Areas.Spa.Extensions
{
    ...
    public class ODataVersionControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public ODataVersionControllerSelector(HttpConfiguration configuration) : base(configuration) { } 
        
        public Dictionary<string, string> RouteVersionSuffixMapping { get { return _routeVersionSuffixMapping; } }
        ...
        public override string GetControllerName(HttpRequestMessage request)
        {
            ...
            string versionControllerName = controllerName + _routeVersionSuffixMapping[routeName];
